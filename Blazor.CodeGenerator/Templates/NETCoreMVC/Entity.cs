...
namespace CodeGenerator.Templates.NETCoreMVC
{
    public class ProcessEntity
    {
        ...
        public string Name { get; set; } = "API-01 - Entity";
        ...
        {
            OutputFolder = CodeGeneratorModel.PathGenerate + "/Entities/";
            ...
            try
            {
                if (Table.Columns.Exists(x=>x.IsPrimaryKey))
                {
                    ...
                    if (normalColumns != null && normalColumns.Count > 0)
                    {
                        ...
                        {
                            if (column.Code != "LastUpdate" && column.Code != "UpdatedBy" && column.Code != "CreatedBy" && column.Code != "CreationDate")
                            {
