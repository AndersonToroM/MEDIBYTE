...
namespace Dominus.Frontend.Mvc
{
    public class ControlEntidadConfiguration
    {
        ...
        public ControlEntidadConfiguration(SelectBoxBuilder selectBox, DataGridBuilder<object> dataGrid)
        {
        ...
        public ControlEntidadConfiguration Modal(string titleModal, string widthModal)
        {
        ...
        public ControlEntidadConfiguration Columns(Action<CollectionFactory<DataGridColumnBuilder<object>>> columns)
        {
            ColumnsGrid = columns;
            return this;
        }

        public SelectBoxBuilder BuilderToWidget(ControlEntidadConfiguration config)
        {
        ...
        private DataGridBuilder<object> GridControlEntidad(string idComponent, Action<CollectionFactory<DataGridColumnBuilder<object>>> columns)
        {
