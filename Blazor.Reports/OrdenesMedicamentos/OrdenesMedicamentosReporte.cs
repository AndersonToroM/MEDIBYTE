...
namespace Blazor.Reports.OrdenesMedicamentos
{
    public partial class OrdenesMedicamentosReporte
    {
        ...
        public OrdenesMedicamentosReporte(ReporteModel _informacionReporte, bool _isFromRoot = false)
        {
            this.InformacionReporte = _informacionReporte;
            this.IsFromRoot = _isFromRoot;
            InitializeComponent();
        }
