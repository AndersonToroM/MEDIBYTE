...
namespace Blazor.Infrastructure.Entities
{
    ...
    public partial class Empresas : BaseEntity
    {
        ...
        [Column("AnioEnvioFE")]
        [DDisplayName("Empresas.AnioEnvioFE")]
        public virtual Int32 AnioEnvioFE { get; set; }

        [Column("ConsecutivoEnvioFE")]
        [DDisplayName("Empresas.ConsecutivoEnvioFE")]
        public virtual Int32 ConsecutivoEnvioFE { get; set; }

        [Column("CodigoPT")]
        [DDisplayName("Empresas.CodigoPT")]
        [DRequired("Empresas.CodigoPT")]
        [DStringLength("Empresas.CodigoPT", 3)]
        public virtual String CodigoPT { get; set; }
