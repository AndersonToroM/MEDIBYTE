...
namespace Blazor.Infrastructure.Entities
{
    ...
    public partial class Pacientes : BaseEntity
    {
       ...
       [Column("CodigoPostal")]
       [DDisplayName("Pacientes.CodigoPostal")]
       [DStringLength("Pacientes.CodigoPostal",6)]
       ...
       [ForeignKey("ZonaTerritorialResidenciaId")]
       public virtual ZonaTerritorialResidencia ZonaTerritorialResidencia { get; set; }
       ...
       public override List<ExpRecurso> GetEliminarExpression<T>()
       {
        ...
        Expression<Func<EntregaResultadosNoLectura, bool>> expression2 = entity => entity.PacientesId == this.Id;
        rules.Add(new ExpRecurso(expression2.ToExpressionNode() , new Recurso("BLL.BUSINESS.DELETE_REL","EntregaResultadosNoLectura"), typeof(EntregaResultadosNoLectura)));

        Expression<Func<Facturas, bool>> expression3 = entity => entity.PacientesId == this.Id;
        rules.Add(new ExpRecurso(expression3.ToExpressionNode() , new Recurso("BLL.BUSINESS.DELETE_REL","Facturas"), typeof(Facturas)));

        Expression<Func<FacturasGeneracion, bool>> expression4 = entity => entity.PacientesId == this.Id;
        ...
        Expression<Func<HistoriasClinicas, bool>> expression5 = entity => entity.PacientesId == this.Id;
        ...
        Expression<Func<ImagenesDiagnosticas, bool>> expression6 = entity => entity.PacientesId == this.Id;
        rules.Add(new ExpRecurso(expression6.ToExpressionNode() , new Recurso("BLL.BUSINESS.DELETE_REL","ImagenesDiagnosticas"), typeof(ImagenesDiagnosticas)));

        Expression<Func<Incapacidades, bool>> expression7 = entity => entity.PacientesId == this.Id;
        ...
        Expression<Func<IndicacionesMedicas, bool>> expression8 = entity => entity.PacientesId == this.Id;
        ...
        Expression<Func<Notas, bool>> expression9 = entity => entity.PacientesId == this.Id;
        rules.Add(new ExpRecurso(expression9.ToExpressionNode() , new Recurso("BLL.BUSINESS.DELETE_REL","Notas"), typeof(Notas)));

        Expression<Func<NotasDetalles, bool>> expression10 = entity => entity.PacientesId == this.Id;
        rules.Add(new ExpRecurso(expression10.ToExpressionNode() , new Recurso("BLL.BUSINESS.DELETE_REL","NotasDetalles"), typeof(NotasDetalles)));

        Expression<Func<OrdenesMedicamentos, bool>> expression11 = entity => entity.PacientesId == this.Id;
        ...
        Expression<Func<OrdenesServicios, bool>> expression12 = entity => entity.PacientesId == this.Id;
        ...
        Expression<Func<PacientesEntidades, bool>> expression13 = entity => entity.PacientesId == this.Id;
        rules.Add(new ExpRecurso(expression13.ToExpressionNode() , new Recurso("BLL.BUSINESS.DELETE_REL","PacientesEntidades"), typeof(PacientesEntidades)));

        Expression<Func<ProgramacionCitas, bool>> expression14 = entity => entity.PacientesId == this.Id;
        rules.Add(new ExpRecurso(expression14.ToExpressionNode() , new Recurso("BLL.BUSINESS.DELETE_REL","ProgramacionCitas"), typeof(ProgramacionCitas)));

        Expression<Func<Recaudos, bool>> expression15 = entity => entity.PacientesId == this.Id;
