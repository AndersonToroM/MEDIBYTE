...
namespace Blazor.Infrastructure.Entities
{
    ...
    public partial class HistoriasClinicas : BaseEntity
    {
       ...
       [DDisplayName("HistoriasClinicas.DetalleAnulacion")]
       ...
       public override List<ExpRecurso> GetAdicionarExpression<T>()
       {
        ...
        expression = entity => entity.AtencionesId == this.AtencionesId;
        rules.Add(new ExpRecurso(expression.ToExpressionNode() , new Recurso("BLL.BUSINESS.UNIQUE", "HistoriasClinicas.AtencionesId" )));
       ...
       public override List<ExpRecurso> GetModificarExpression<T>()
       {
        ...
        expression = entity => !(entity.Id == this.Id && entity.AtencionesId == this.AtencionesId)
                               && entity.AtencionesId == this.AtencionesId;
        rules.Add(new ExpRecurso(expression.ToExpressionNode() , new Recurso("BLL.BUSINESS.UNIQUE", "HistoriasClinicas.AtencionesId" )));
