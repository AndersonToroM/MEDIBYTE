...
namespace Blazor.BusinessLogic.Jobs
{
    ...
    public class IntegracionConsultaDocumentoFEJob : IJob
    {
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            {
                new JobsBusinessLogic(tenant.DataBaseSetting).SaveJobLog(nameof(IntegracionConsultaDocumentoFEJob), false, "Error Ejecutando Rutina", ex.GetBackFullErrorMessage());
            }
        }
    }
